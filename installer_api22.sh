...
APPVERSION="2.32.1"
APPPATH="44'/60'"
LOAD_PARAMS="--targetId 0x33100004 --targetVersion=1.3.1 --apiLevel 22 --fileName bin/app.hex --appName Noble60 --appVersion 2.32.1 --curve secp256k1 --tlv"
...
#!/usr/bin/env bash
#*******************************************************************************
#  Noble60 Ledger App Installer - API Level 22 (Firmware 1.3.1/1.3.2)
#*******************************************************************************
#  Based on Zondax installer scripts
#
#  This is a self-contained installer for the Noble60 Ledger app
#  built for firmware 1.3.1/1.3.2 (API Level 22).
#
#  Requirements:
#    - Python 3
...
#
#  Usage:
#    ./installer_api22.sh load    - Install Noble60 app to device
#    ./installer_api22.sh delete  - Remove Noble60 app from device
...
case "$1" in
  ...
  cd "$TMP_HEX_DIR" || exit
  echo "==============================================================================="
  echo "  Installing Noble60 App - API Level 22 (Firmware 1.3.1/1.3.2)"
  echo "==============================================================================="
  echo ""
  ...
  *)
    echo "==============================================================================="
    echo "  Noble60 Installer - API Level 22 (Firmware 1.3.1/1.3.2)"
    echo "==============================================================================="
    echo ""
