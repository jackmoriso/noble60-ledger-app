#!/bin/bash
#===============================================================================
# Noble60 App Builder - API Level 22 (Firmware 1.3.1/1.3.2)
#===============================================================================
# This script builds the Noble60 Ledger app for firmware 1.3.1/1.3.2 using
...
#
# Output:
#   - builds/api22/app.hex - Binary for physical Ledger installation
#   - builds/api22/app.elf - Binary for Speculos simulator
#   - builds/api22/app.sha256 - SHA-256 checksum
#===============================================================================
...
echo -e "${BLUE}===============================================================================${NC}"
echo -e "${BLUE}  Building Noble60 App - API Level 22 (Firmware 1.3.1/1.3.2)${NC}"
echo -e "${BLUE}===============================================================================${NC}"
echo ""
...
OUTPUT_DIR="${PROJECT_DIR}/builds/api22"
API_LEVEL=22
SDK_VERSION="API_LEVEL_22"
